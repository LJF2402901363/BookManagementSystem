    ...
    $(function () {
        var table = $("#productTable").DataTable({
            ...
            "ajax": {
                ...
                url: "${pageContext.request.contextPath}/reader/findAll.do",//请求地址
                type: 'POST',
        ...
        $("#productTable tbody").on("click", "#deleteProductBtn", function() {
            ...
            $.ajax({
                "url":"${pageContext.request.contextPath}/deleteReader.html",
                "type":"POST",
