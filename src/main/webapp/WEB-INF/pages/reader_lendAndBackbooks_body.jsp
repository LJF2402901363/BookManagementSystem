    ...
    $(function () {
        var table = $("#productTable").DataTable({
                ...
                { "data": "backDate" },
                {
                    ...
                    render: function(data, type, row, meta) {
                        return '<div class="text-center">'
                            ...
                            +'<button type="button" class="btn btn-block btn-info btn-sm" id="deleteBackBookBtn" >删除记录</button>'
                            +'</div>';
                    }
                }
            ],
            ...
            "ajax": {
                ...
                url: "${pageContext.request.contextPath}/lend/findLendAndBackAll.do",//请求地址
                type: 'POST',
        ...
        //给操作列的按钮添加点击事件
        $("#productTable tbody").on("click", "#deleteBackBookBtn", function() {

            // //获取行
            var row = table.row($(this).closest('tr')).data();
            $.ajax({
                "url":"${pageContext.request.contextPath}/deleteLendBok",
                "type":"POST",
                "data":{"serNum":row.serNum},
                "dataType":"json",
